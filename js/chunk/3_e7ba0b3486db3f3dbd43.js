/*! For license information please see 3_e7ba0b3486db3f3dbd43.js.LICENSE.txt */
  ...
  [3],
  {
    789: function (e, T, o) {
      ...
      var i = o(16),
        ...
        A = o(762),
        l = (function () {
          function NodesRef(e, T, o) {
            Object(t.a)(this, NodesRef),
            ...
            Object(S.a)(NodesRef, [
              {
                ...
                value: function context(e) {
                  ...
                  return t._push(T, o, i, { context: !0 }, e), t
                },
              },
              {
                key: 'node',
                value: function node(e) {
                  var T = this._selector,
                    ...
                    t = this._selectorQuery
                  return (
                    t._push(T, o, i, { nodeCanvasType: !0, node: !0 }, e), t
                  )
                },
              },
              {
      ...
      function filter(e, T, o) {
        ...
        if (B && c) {
          var C = T.tagName
          if (
            ((d.node = { id: T.id, $taroElement: T }),
            /^taro-canvas-core/i.test(C))
          ) {
            var u = T.type || ''
            d.nodeCanvasType = u
            var E = T.getElementsByTagName('canvas')[0]
            ;/^(2d|webgl)/i.test(u) && E ? (d.node = E) : (d.node = null)
          } else (d.nodeCanvasType = ''), (d.node = T)
          return d
        }
        if (!H) {
          if (
            (t && (d.id = T.id), S && (d.dataset = r()({}, T.dataset)), n || a)
          ) {
            ...
            n &&
              (i
                ...
                : ((d.left = h), (d.right = D), (d.top = V), (d.bottom = p))),
              a &&
                (i
                  ? ((d.width = T.clientWidth), (d.height = T.clientHeight))
                  : ((d.width = m), (d.height = N)))
          }
          if (
            (b && ((d.scrollLeft = T.scrollLeft), (d.scrollTop = T.scrollTop)),
            l.length &&
              P()(l).call(l, function (e) {
            ...
            P()(G).call(G, function (e) {
              var T = L.getPropertyValue(e) || L[e]
              T && (d[e] = T)
            })
          }
          return d
        ...
        var f = T.tagName
        if (/^taro-video-core/i.test(f)) return { context: T }
        if (/^taro-canvas-core/i.test(f)) {
          var O = T.type || '2d',
            R = null == T ? void 0 : T.querySelector('canvas'),
            w = null == R ? void 0 : R.getContext(O)
          return { context: new A.a(R, w) }
        }
        ;/^taro-live-player-core/i.test(f)
          ? console.error(
              '暂时不支持通过 NodesRef.context 获取 LivePlayerContext',
            )
          : /^taro-editor-core/i.test(f)
          ? console.error('暂时不支持通过 NodesRef.context 获取 EditorContext')
          : /^taro-map-core/i.test(f) &&
            console.error('暂时不支持通过 NodesRef.context 获取 MapContext')
      }
      var s = (function () {
          function SelectorQuery() {
            Object(t.a)(this, SelectorQuery),
                    ...
                    (function queryBat(e, T) {
                      ...
                      P()(e).call(e, function (e) {
                        var T,
                          ...
                          n = e.fields,
                          r = e.component,
                          a = (null !== r && Object(i.b)(r)) || document,
                          P = !1
                        if (a !== document) {
                          var b =
                        ...
                        if (S) {
                          var s = !0 === P ? a : a.querySelector(t)
                          o.push(filter(n, s, t))
                        } else {
                          var G = a.querySelectorAll(t),
                            B = []
                          !0 === P && B.push(a)
                          for (var c = 0, H = G.length; c < H; ++c) B.push(G[c])
                          o.push(
                            M()(B).call(B, function (e) {
                              return filter(n, e)
                            }),
                          )
                        }
                      ...
                      var i = T._queueCb
                      P()(o).call(o, function (e, o) {
                        var t = i[o]
                        'function' == typeof t && t.call(T, e)
                      }),
                        'function' == typeof e && e.call(T, o)
                    }),
                    this
                  )
                },
        ...
        G = function createSelectorQuery() {
          return new s()
        }
      Object(i.j)('createIntersectionObserver')
    },
    814: function (e, T, o) {
      ;(e.exports
        ? function (T) {
        ...
        return (
          ...
          (function init() {
            var i,
              ...
              r,
              a,
              P = T.mobileDetectRules
            for (i in P.props)
              if (o.call(P.props, i)) {
                for (
                  t = P.props[i], e(t) || (t = [t]), r = t.length, n = 0;
                  n < r;
                  ++n
                )
                  (a = (S = t[n]).indexOf('[VER]')) >= 0 &&
                    (S =
                      S.substring(0, a) + '([\\w._\\+]+)' + S.substring(a + 5)),
                    (t[n] = new RegExp(S, 'i'))
                P.props[i] = t
              }
            convertPropsToRegExp(P.oss),
              convertPropsToRegExp(P.phones),
              convertPropsToRegExp(P.tablets),
              convertPropsToRegExp(P.uas),
              convertPropsToRegExp(P.utils),
              (P.oss0 = {
          ...
          (T.findMatch = function (e, T) {
            for (var i in e) if (o.call(e, i) && e[i].test(T)) return i
            return null
          }),
          ...
          (T.prepareDetectionCache = function (e, o, i) {
            if (void 0 === e.mobile) {
              var t, S, n
              if ((S = T.findMatch(T.mobileDetectRules.tablets, o)))
                return (e.mobile = e.tablet = S), void (e.phone = null)
              if ((t = T.findMatch(T.mobileDetectRules.phones, o)))
                return (e.mobile = e.phone = t), void (e.tablet = null)
              T.isMobileFallback(o)
                ? void 0 === (n = MobileDetect.isPhoneSized(i))
          ...
          (MobileDetect.prototype = {
            ...
            is: function (e) {
              return (
                containsIC(this.userAgents(), e) ||
                equalIC(e, this.os()) ||
                equalIC(e, this.phone()) ||
                equalIC(e, this.tablet()) ||
                containsIC(T.findMatches(T.mobileDetectRules.utils, this.ua), e)
              )
            },
            match: function (e) {
              return (
          ...
          'undefined' != typeof window && window.screen
            ? (MobileDetect.isPhoneSized = function (e) {
    ...
    816: function (e, T, o) {
      ...
      ;(T.byteLength = function byteLength(e) {
        ...
        (T.toByteArray = function toByteArray(e) {
          ...
          for (o = 0; o < b; o += 4)
            (T =
              ...
              (a[P++] = 255 & T)
          2 === r &&
            ((T = (t[e.charCodeAt(o)] << 2) | (t[e.charCodeAt(o + 1)] >> 4)),
            (a[P++] = 255 & T))
          1 === r &&
            ((T =
              (t[e.charCodeAt(o)] << 10) |
        ...
        (T.fromByteArray = function fromByteArray(e) {
          for (
            var T, o = e.length, t = o % 3, S = [], n = 0, r = o - t;
            n < r;
            n += 16383
          )
            S.push(encodeChunk(e, n, n + 16383 > r ? r : n + 16383))
          1 === t
      ...
      var i = o(814),
        ...
        S =
          ...
          function getSystemInfoSync() {
            var e = new t.a(navigator.userAgent)
            return {
              brand: e.mobile() || '',
              model: e.mobile() || '',
              system: e.os(),
    ...
    864: function (e, T, o) {
      ...
      var i = o(16),
        t = Object(i.j)('getUserProfile')
      Object(i.j)('getUserInfo')
    },
    865: function (e, T, o) {
      'use strict'
      o.d(T, 'a', function () {
      ...
      var i = o(16),
        t = Object(i.j)('getMenuButtonBoundingClientRect')
    },
  },
])
