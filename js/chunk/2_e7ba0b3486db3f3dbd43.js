/*! For license information please see 2_e7ba0b3486db3f3dbd43.js.LICENSE.txt */
  ...
  [2],
  {
    ...
    709: function (t, r, i) {
      ...
      function _regeneratorRuntime() {
        ...
        var t = {},
          r = Object.prototype,
          i = r.hasOwnProperty,
          a = 'function' == typeof c.a ? c.a : {},
          u = a.iterator || '@@iterator',
          h = a.asyncIterator || '@@asyncIterator',
          v = a.toStringTag || '@@toStringTag'
          ...
          return (
            (c._invoke = (function (t, r, i) {
              ...
              return function (a, c) {
                ...
                for (i.method = a, i.arg = c; ; ) {
                  var u = i.delegate
                  if (u) {
                    var l = maybeInvokeDelegate(u, i)
                    if (l) {
                      if (l === d) continue
                      return l
                    }
                  ...
                  o = 'executing'
                  var h = tryCatch(t, r, i)
                  if ('normal' === h.type) {
                    if (
                      ((o = i.done ? 'completed' : 'suspendedYield'),
                      h.arg === d)
                    )
                      continue
                  ...
                  'throw' === h.type &&
                    ((o = 'completed'), (i.method = 'throw'), (i.arg = h.arg))
                }
              }
            })(t, i, u)),
            c
        ...
        function defineIteratorMethods(t) {
          var r
          g()((r = ['next', 'throw', 'return'])).call(r, function (r) {
        ...
        return (
          ...
          define(q, 'constructor', GeneratorFunctionPrototype),
          ...
          (t.mark = function (t) {
            return (
              w.a
                ? w()(t, GeneratorFunctionPrototype)
                : ((t.__proto__ = GeneratorFunctionPrototype),
                  define(t, v, 'GeneratorFunction')),
              (t.prototype = y()(q)),
              t
            )
          }),
          ...
          (t.async = function (r, i, o, a, c) {
            void 0 === c && (c = k.a)
            var u = new AsyncIterator(wrap(r, i, o, a), c)
          ...
          defineIteratorMethods(q),
          define(q, v, 'Generator'),
          define(q, u, function () {
            return this
          }),
          ...
          (Context.prototype = {
            ...
            reset: function reset(t) {
              ...
              if (
                ...
                (this.method = 'next'),
                (this.arg = void 0),
                g()((r = this.tryEntries)).call(r, resetTryEntry),
                !t)
              )
                for (var o in this)
                  't' === o.charAt(0) &&
            ...
            finish: function finish(t) {
              for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                ...
                if (i.finallyLoc === t)
                  return (
                    this.complete(i.completion, i.afterLoc), resetTryEntry(i), d
                  )
              }
            },
            ...
            delegateYield: function delegateYield(t, r, i) {
              return (
                (this.delegate = {
                  iterator: values(t),
                  resultName: r,
    ...
    710: function (t, r, i) {
      ...
      function asyncGeneratorStep(t, r, i, o, c, u, l) {
        ...
        h.done ? r(y) : a.a.resolve(y).then(o, c)
      }
      function _asyncToGenerator(t) {
        return function () {
          var r = this,
            i = arguments
          return new a.a(function (o, a) {
            var c = t.apply(r, i)
            function _next(t) {
              asyncGeneratorStep(c, o, a, _next, _throw, 'next', t)
            }
            function _throw(t) {
              asyncGeneratorStep(c, o, a, _next, _throw, 'throw', t)
            }
            _next(void 0)
          })
        }
          ...
          return (
            Object(g.a)(CanvasContext, [
              ...
              },
              {
                ...
                value:
                  ((t = Object(p.a)(
                    Object(o.a)().mark(function _callee(t, r) {
                      var i, a, c, u, l
                          ...
                          for (;;)
                            switch ((o.prev = o.next)) {
                              ...
                              case 11:
                                ...
                                break
                              case 13:
                                ;(o.prev = 13), (o.t0 = o.catch(3)), i.e(o.t0)
                              case 16:
                                return (o.prev = 16), i.f(), o.finish(16)
                              case 19:
                                this.emptyActions(), r && r(), (o.next = 26)
                                break
                              case 23:
                                throw (
                                  ((o.prev = 23),
              ...
              },
              {
                ...
                value: function drawImage(t) {
                  ...
                  this.enqueueActions(function () {
                    ...
                    ;(i = r.ctx).drawImage.apply(i, k()((a = [t])).call(a, o))
                  })
                },
              },
              {
              ...
              {
                key: 'setShadow',
                value: function setShadow(t, r, i, o) {
                  var a = this
                  this.enqueueActions(function () {
                    ;(a.ctx.shadowOffsetX = t),
                      (a.ctx.shadowOffsetY = r),
                      (a.ctx.shadowColor = o),
                      (a.ctx.shadowBlur = i)
                  })
                },
              ...
              },
              {
                ...
                value: function createLinearGradient(t, r, i, o) {
                  return this.createLinearGradient(t, r, i, o)
                },
              },
            ]),
            CanvasContext
    ...
    805: function (t, r, i) {
      var o = i(806)
      i(807), i(808), i(809), i(810), (t.exports = o)
    },
    806: function (t, r, i) {
      var o = i(247)
      t.exports = o
