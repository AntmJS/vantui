        ...
        a.r(e),
          (e.default = {
            config: {
              title: 'antmjs Vantui',
              src: [
                '/Users/apple/Desktop/Dian/vantui/packages/vantui/src',
                '/Users/apple/Desktop/Dian/vantui/packages/vantui/docs',
              ],
              globalStyles: [
                '/Users/apple/Desktop/Dian/vantui/packages/vantui/docs/theme.less',
              ],
              ...
              menu: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { path: 'power-scroll-view', title: '滚动&下拉刷新' },
                  ],
                },
                {
                  name: '导航组件',
              ...
              headerLinks: [
                {
                  ...
                  url: 'https://github.com/AntmJS/vantui/tree/v2',
                  type: 'img',
                },
                {
                  title: '2.5.7',
                  type: 'select',
                  options: [{ title: 'v3', url: '/vantui/main' }],
                },
                {
                  title: '更多',
                  type: 'select',
