  ...
  [46, 5],
  {
    ...
    538: function (e, t, n) {
      ...
      function Loading(e) {
        var t,
          ...
          h = e.style,
          b = l()(e, D),
          j = Object(N.useState)(u()({ length: 12 })),
          m = i()(j, 1)[0]
              ...
              children: [
                Object(L.jsx)(A.n, {
                  ...
                  children:
                    'spinner' === r &&
                    Object(L.jsx)(A.a, {
                      children: f()(m).call(m, function (e, t) {
                        return Object(L.jsx)(
                          A.n,
    ...
    562: function (e, t, n) {
      ...
      function useTransition(e) {
        ...
        return (
          Object(s.useEffect)(
            function () {
              !n || (M && l()(M).call(M, Y['enter-to'])) || B(), n || Z()
            },
            [n],
          ),
          {
            ...
            {},
            {
              children: [
                ...
                Object(N.jsx)(k.n, {
                  ...
                  children:
                    j || 0 === j ? Object(N.jsx)(k.a, { children: j }) : D,
                }),
                s
                  ? Object(N.jsx)(S.a, {
    ...
    587: function (e, t, n) {
      ...
      var a = n(22),
        ...
        U = n(605),
        F = n(108),
        R = ['style', 'className', 'children', 'zIndex']
      function ownKeys(e, t) {
        var n = r()(e)
        if (i.a) {
          var a = i()(e)
                ...
                children: Object(F.jsxs)(
                  ...
                  _objectSpread(
                    ...
                    {},
                    {
                      children: [
                        'text' === r.type
                          ? Object(F.jsx)(A.k, { children: r.message })
                          : 'html' === r.type
                          ? Object(F.jsx)(A.i, { nodes: r.message })
                          : Object(F.jsxs)(A.n, {
    ...
    754: function (e, t, n) {
      ...
      ;(m.style.cssText =
        ...
        'standard' === m.style['animation-name']
          ? ((b = 'transitionend'), (j = 'transform'))
          : 'webkit' === m.style['-webkit-animation-name']
          ? ((b = 'webkitTransitionEnd'), (j = '-webkit-transform'))
          : 'moz' === m.style['-moz-animation-name']
          ? ((b = 'mozTransitionEnd'), (j = '-moz-transform'))
          : 'ms' === m.style['-ms-animation-name'] &&
            ((b = 'msTransitionEnd'), (j = '-ms-transform'))
      var p = 0,
        O = (function () {
          function Animation() {
            var e = this,
            ...
            ;(this.id = ++p),
              document.body.addEventListener(b, function (t) {
                var n = t.target
                null === n.getAttribute(m) && (m = 'data-animation')
                var r = n.getAttribute(m)
                if (null !== r) {
                  var c = r.split('__'),
                    i = Object(a.a)(c, 2),
                    l = i[0],
            ...
            Object(r.a)(Animation, [
              ...
              },
              {
                ...
                value: function matrix3d(
                  ...
                  var m, p, O, y, g, x, _, k, w, C, S, T, A, N, I
                  return (
                    this.transform.push(
                      o()(
                        (m = o()(
              ...
              },
              {
                ...
                value: function step() {
                  var e,
                    ...
                    m = c.transformOrigin,
                    p = void 0 === m ? i.transformOrigin : m
                  return (
                    this.steps.push(
                      d()(
                        (e = [
    ...
    869: function (e, t, n) {
      ...
      function _objectSpread(e) {
        for (var t = 1; t < arguments.length; t++) {
          var n,
            a = null != arguments[t] ? arguments[t] : {}
          if (t % 2)
            _()((n = ownKeys(Object(a), !0))).call(n, function (t) {
              c()(e, t, a[t])
            })
          else if (w.a) S()(e, w()(a))
          else {
            var r
            _()((r = ownKeys(Object(a)))).call(r, function (t) {
              v()(e, t, g()(a, t))
            })
          }
        }
      ...
      var E = function Collapse(e) {
          var t = e.value,
            ...
            p = Object(T.useCallback)(
              function (e, n, r) {
                ...
                !a && Array.isArray(t)
                  ? (n = r
                      ? s()((c = t || [])).call(c, n)
                      : d()((o = t || [])).call(o, function (e) {
                          return e !== n
                        }))
                  : (n = r ? n : '')
                v()(e, 'detail', { value: f, writable: !0 }),
                  r ? null == i || i(e) : null == l || l(e),
                  (e.detail = n),
                  null == u || u(e)
              },
              [t, a, i, l, u],
            ...
            O = Object(T.useMemo)(
              function () {
                return b()(T.Children).call(T.Children, j, function (e, n) {
        ...
        L = (n(530), n(531), n(570), n(789), n(524)),
        D = n.n(L),
        z = n(117),
        K = n.n(z),
        U = n(87),
      ...
      function animate_objectSpread(e) {
        for (var t = 1; t < arguments.length; t++) {
          var n,
            a = null != arguments[t] ? arguments[t] : {}
          if (t % 2)
            _()((n = animate_ownKeys(Object(a), !0))).call(n, function (t) {
              c()(e, t, a[t])
            })
          else if (w.a) S()(e, w()(a))
          else {
            var r
            _()((r = animate_ownKeys(Object(a)))).call(r, function (t) {
              v()(e, t, g()(a, t))
            })
          }
        }
      ...
      function setContentAnimate(e, t, n, a, r) {
        Object(X.c)(e, '.van-collapse-item__content')
          .then(function (e) {
      ...
      function collapse_item_objectSpread(e) {
        for (var t = 1; t < arguments.length; t++) {
          var n,
            a = null != arguments[t] ? arguments[t] : {}
          if (t % 2)
            _()((n = collapse_item_ownKeys(Object(a), !0))).call(
              n,
              function (t) {
                c()(e, t, a[t])
              },
            ...
            var r
            _()((r = collapse_item_ownKeys(Object(a)))).call(r, function (t) {
              v()(e, t, g()(a, t))
            })
          }
        }
      ...
      var q = function CollapseItem(e) {
          var t = Object(T.useRef)({ mounted: !1 }),
            n = Object(T.useState)({
              index: void 0,
              expanded: !1,
              animation: { actions: [] },
          ...
          var X = Object(T.useRef)(null),
            q = Object(T.useCallback)(
              function () {
                var e
                if (l) {
                  var n = null == l ? void 0 : l.data,
                    a = n.value,
                    i = n.accordion,
                    o = null == l ? void 0 : l.index,
                    s = null == u ? o : u,
                    d = i
                      ? a === s
                      : K()((e = a || [])).call(e, function (e) {
                          return e === s
                        })
                  d !== r.expanded &&
                    setContentAnimate(null, d, t.current.mounted, c, X),
                    c(function (e) {
                      return collapse_item_objectSpread(
                        collapse_item_objectSpread({}, e),
                        {},
          ...
          var B = Object(T.useCallback)(
            function (e) {
              if (!p) {
                var t = null == u ? (null == l ? void 0 : l.index) : u
                null == l || l.handleSwitch(e, t, !r.expanded)
              }
            },
            [l, p, u, r.expanded],
          )
              ...
              {},
              {
                children: [
                  Object(N.jsx)(R.b, {
                    ...
                    border: x && r.expanded,
                    className:
                      F.b('collapse-item__title', {
                        disabled: p,
                        expanded: r.expanded,
                      }) + ' van-cell',
                    onClick: B,
                    renderTitle: Object(N.jsx)(A.a, { children: w }),
                    renderIcon: Object(N.jsx)(A.a, { children: C }),
                    renderRightIcon: Object(N.jsx)(A.a, { children: S }),
                    children: I,
                  }),
                  Object(N.jsx)(A.n, {
                    className:
                      F.b('collapse-item__wrapper', {}) +
                      ' van-collapse-item__animation-box',
                    animation: r.animation,
                    children: Object(N.jsx)(A.n, {
          ...
          (function (e) {
            ...
            function Index() {
              ...
              return (
                ...
                Object(J.a)(Object($.a)(e), 'onChange', function (t) {
                  var n = t.currentTarget.dataset.key
                  e.setState(Object(J.a)({}, n, t.detail))
                }),
                Object(J.a)(Object($.a)(e), 'onOpen', function (e) {
                  B.a.show('展开: '.concat(e.detail))
                }),
                Object(J.a)(Object($.a)(e), 'onClose', function (e) {
                  B.a.show('关闭: '.concat(e.detail))
                }),
                e
              )
            }
                        ...
                        children: [
                            ...
                            children: Object(N.jsxs)(E, {
                              ...
                              onChange: function onChange(t) {
                                e.onChange({
                                  ...
                                  target: { dataset: { key: 'active1' } },
                                })
                              },
                              children: [
                                Object(N.jsx)(q, { title: r, children: c }),
                                Object(N.jsx)(q, { title: i, children: o }),
                                Object(N.jsx)(q, {
                                  title: l,
                                  disabled: !0,
                                  children: s,
                          ...
                          Object(N.jsx)(G.a, {
                            ...
                            children: Object(N.jsxs)(E, {
                              ...
                              children: [
                                Object(N.jsx)(q, { title: r, children: c }),
                                Object(N.jsx)(q, { title: i, children: o }),
                                Object(N.jsx)(q, { title: l, children: s }),
                              ],
                            }),
                          }),
                          Object(N.jsx)(G.a, {
                          ...
                          Object(N.jsx)(G.a, {
                            ...
                            children: Object(N.jsxs)(E, {
                              ...
                              children: [
                                Object(N.jsx)(q, {
                                  renderTitle: Object(N.jsx)(N.Fragment, {
                                    children: Object(N.jsxs)(A.n, {
                                      children: [
                                        r,
                                        Object(N.jsx)(a.b, {
                                          name: 'question-o',
