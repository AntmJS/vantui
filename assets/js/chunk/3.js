...
;(window.webpackJsonp = window.webpackJsonp || []).push([
  [3],
  {
        ...
        return (
          ...
          (function init() {
            var i,
              ...
              n,
              r,
              P = e.mobileDetectRules
            for (i in P.props)
              if (S.call(P.props, i)) {
                for (
                  o = P.props[i], T(o) || (o = [o]), n = o.length, a = 0;
                  a < n;
                  ++a
                )
                  (r = (t = o[a]).indexOf('[VER]')) >= 0 &&
                    (t =
                      t.substring(0, r) + '([\\w._\\+]+)' + t.substring(r + 5)),
                    (o[a] = new RegExp(t, 'i'))
                P.props[i] = o
              }
          ...
          (e.getVersionStr = function (T, i) {
            ...
            if (S.call(r, T))
              for (a = (o = r[T]).length, t = 0; t < a; ++t)
                if (null !== (n = o[t].exec(i))) return n[1]
            return null
          }),
          ...
          (e.isMobileFallback = function (T) {
            return (
              e.detectMobileBrowsers.fullPattern.test(T) ||
              e.detectMobileBrowsers.shortPattern.test(T.substr(0, 4))
            )
          }),
          ...
          (e.prepareDetectionCache = function (T, S, i) {
            if (void 0 === T.mobile) {
              var o, t, a
              if ((t = e.findMatch(e.mobileDetectRules.tablets, S)))
                return (T.mobile = T.tablet = t), void (T.phone = null)
              if ((o = e.findMatch(e.mobileDetectRules.phones, S)))
                return (T.mobile = T.phone = o), void (T.tablet = null)
              e.isMobileFallback(S)
                ? void 0 === (a = MobileDetect.isPhoneSized(i))
                  ? ((T.mobile = e.FALLBACK_MOBILE),
                    (T.tablet = T.phone = null))
                  : a
                  ? ((T.mobile = T.phone = e.FALLBACK_PHONE), (T.tablet = null))
                  : ((T.mobile = T.tablet = e.FALLBACK_TABLET),
                    (T.phone = null))
          ...
          (e.detectOS = function (T) {
            return (
              e.findMatch(e.mobileDetectRules.oss0, T) ||
              e.findMatch(e.mobileDetectRules.oss, T)
            )
          }),
          ...
          (MobileDetect.prototype = {
            ...
            userAgent: function () {
              return (
                void 0 === this._cache.userAgent &&
                  (this._cache.userAgent = e.findMatch(
                    e.mobileDetectRules.uas,
                    this.ua,
                  )),
            ...
            userAgents: function () {
              return (
                void 0 === this._cache.userAgents &&
                  (this._cache.userAgents = e.findMatches(
                    e.mobileDetectRules.uas,
                    this.ua,
                  )),
            ...
            is: function (T) {
              return (
                containsIC(this.userAgents(), T) ||
                equalIC(T, this.os()) ||
                equalIC(T, this.phone()) ||
                equalIC(T, this.tablet()) ||
                containsIC(e.findMatches(e.mobileDetectRules.utils, this.ua), T)
              )
            },
            match: function (T) {
              return (
                T instanceof RegExp || (T = new RegExp(T, 'i')), T.test(this.ua)
              )
            },
          ...
          'undefined' != typeof window && window.screen
            ? (MobileDetect.isPhoneSized = function (T) {
                return T < 0 ? void 0 : e.getDeviceSmallerSide() <= T
              })
            : (MobileDetect.isPhoneSized = function () {}),
          (MobileDetect._impl = e),
      ...
      ;(e.byteLength = function byteLength(T) {
        ...
        (e.toByteArray = function toByteArray(T) {
          ...
          for (S = 0; S < M; S += 4)
            (e =
              (o[T.charCodeAt(S)] << 18) |
              (o[T.charCodeAt(S + 1)] << 12) |
              (o[T.charCodeAt(S + 2)] << 6) |
              o[T.charCodeAt(S + 3)]),
              (r[P++] = (e >> 16) & 255),
              (r[P++] = (e >> 8) & 255),
              (r[P++] = 255 & e)
          2 === n &&
            ((e = (o[T.charCodeAt(S)] << 2) | (o[T.charCodeAt(S + 1)] >> 4)),
            (r[P++] = 255 & e))
          1 === n &&
            ((e =
              (o[T.charCodeAt(S)] << 10) |
              (o[T.charCodeAt(S + 1)] << 4) |
              (o[T.charCodeAt(S + 2)] >> 2)),
            (r[P++] = (e >> 8) & 255),
            (r[P++] = 255 & e))
          return r
        }),
        (e.fromByteArray = function fromByteArray(T) {
          for (
            var e, S = T.length, o = S % 3, t = [], a = 0, n = S - o;
            a < n;
            a += 16383
          )
            t.push(encodeChunk(T, a, a + 16383 > n ? n : a + 16383))
          1 === o
            ? ((e = T[S - 1]), t.push(i[e >> 2] + i[(e << 4) & 63] + '=='))
            : 2 === o &&
              ((e = (T[S - 2] << 8) + T[S - 1]),
              t.push(i[e >> 10] + i[(e >> 4) & 63] + i[(e << 2) & 63] + '='))
          return t.join('')
        })
      for (
        var i = [],
        ...
        (i[n] = a[n]), (o[a.charCodeAt(n)] = n)
      function getLens(T) {
        var e = T.length
        if (e % 4 > 0)
          throw new Error('Invalid string. Length must be a multiple of 4')
        var S = T.indexOf('=')
        return -1 === S && (S = e), [S, S === e ? 0 : 4 - (S % 4)]
      }
      function encodeChunk(T, e, S) {
        for (var o, t, a = [], n = e; n < S; n += 3)
          (o =
            ((T[n] << 16) & 16711680) +
            ((T[n + 1] << 8) & 65280) +
            (255 & T[n + 2])),
      ...
      var i = S(743),
        ...
        t =
          ...
          function getSystemInfoSync() {
            var T = new o.a(navigator.userAgent)
            return {
              brand: T.mobile() || '',
              model: T.mobile() || '',
              system: T.os(),
    ...
    844: function (T, e, S) {
      ...
      var i = S(16),
        o = Object(i.j)('getMenuButtonBoundingClientRect')
    },
  },
])
