/*! For license information please see index_17fa21dd2e67106c46a3.js.LICENSE.txt */
!(function () {
  var e,
    t,
    n = {
      ...
      2967: function (e, t, n) {
        ...
        function Wl(e, t, n, r) {
          ...
          'object' == typeof l && null !== l
            ? (a.context = _l(l))
            : ((l = Oa(t) ? za : Pa.current), (a.context = La(e, l))),
        ...
        function Yl(e) {
          ...
          function v(a, i, u, s) {
            ...
            if (g.done) return n(a, h), al && Za(a, v), c
            if (null === h) {
        ...
        function Pi(e, t, n, r, a) {
          ...
          if ((El(t, a), null === t.stateNode))
            Hi(e, t), Bl(t, n, r), Wl(t, n, r, a), (r = !0)
          else if (null === e) {
            var o = t.stateNode,
              i = t.memoizedProps
            o.props = i
        ...
        function ls(e, t) {
          if (((Ju = -1), (es = 0), 0 != (6 & Tu))) throw Error(l(327))
          var n = e.callbackNode
          ...
          (t.unstable_scheduleCallback = function (e, a, l) {
            ...
            return (
              ...
              l > o
                ...
                : ((e.sortIndex = i), n(s, e), h || m || ((h = !0), j(S))),
              e
            )
          }),
...
`,
      ...
      function ve(e) {
        'function' != typeof e &&
          console.error(
            'usePersistFn expected parameter is a function, got '.concat(he(e)),
          )
        var n = (0, t.useRef)(e)
      ...
      var ke = '',
        Se = function (e) {
          var n = e.markdownMain,
            ...
            o = e.simulator,
            i = e.firstPage,
            u = ge((0, t.useState)(ke), 2),
            s = u[0],
            c = u[1],
            f = ge((0, t.useContext)(me), 2),
            d = f[0],
            p = f[1],
            m = ge((0, t.useState)([]), 2),
            h = m[0],
          ...
          var x,
            ...
            z = ve(function () {
              var e,
                t = document.querySelectorAll('.antm-docs-markdown .card'),
                n = document.querySelectorAll('.antm-docs-markdown .card>h3')
              if (t && t.length)
                    ...
                    g.push({
                      id:
                        null !== (l = n[r]) && void 0 !== l && l.id
                          ...
                          : '',
                      top: (null == a ? void 0 : a.offsetTop) || 0,
                      height: i.height,
                    })
                  }
                }
            ...
            (0, t.useEffect)(
              function () {
                if (!('number' != typeof _ || _ < 0))
                  return (N.current = setTimeout(C, _)), P
              },
              [_, P, C].concat(
                (function (e) {
            ...
            (0, oe.jsxs)(oe.Fragment, {
              children: [
                (0, oe.jsx)('div', {
                  className: r()(
                    'antm-docs-body',
                    1 === h.length && 'antm-docs-body-no-right-navs',
                  ),
                ...
                h.length > 1 &&
                  (0, oe.jsxs)('div', {
                    ...
                    children: [
                      o &&
                        (0, oe.jsx)('div', {
                          className: r()('nav-button', k && 'nav-button-close'),
                          onClick: function () {
                            return S(!k)
                          },
                      ...
                      (0, oe.jsxs)('div', {
                        className: r()(
                          'antm-doc-right-navs',
                          'antm-doc-right-navs-'.concat(k ? 'show' : 'hide'),
                        ),
                        children: [
                          (0, oe.jsx)('div', {
        ...
        return (
          ...
          (0, oe.jsx)('header', {
            ...
            children: (0, oe.jsxs)('div', {
              ...
              children: [
                (0, oe.jsxs)('a', {
                  className: ''.concat(Ce, '-left'),
                  href: '/',
                  children: [
                    r &&
                      (0, oe.jsx)('div', {
                        className: ''.concat(Ce, '-logo'),
                ...
                (0, oe.jsx)('div', {
                  className: ''.concat(Ce, '-right'),
                  children: (0, oe.jsx)('div', {
                    className: ''.concat(Ce, '-navs-box'),
                    children: (a || []).map(function (e, t) {
                      return (0, oe.jsxs)(
                        'div',
                        {
                          className: ''.concat(Ce, '-nav'),
                          children: [
                            'img' === e.type &&
                              (0, oe.jsx)('a', {
                                href: e.url,
        ...
        function w(e, t) {
          function a(r, l, o, i) {
            ...
            if ('throw' !== u.type) {
              var s = u.arg,
                f = s.value
              return f && 'object' == Le(f) && n.call(f, '__await')
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (e.next = 2),
                          Promise.all([
                            a.e(6644).then(a.bind(a, 6644)),
                            a.e(6211).then(a.bind(a, 6211)),
                          ])
                        )
                      case 2:
                        ;(t = e.sent),
      ...
      var Ae = document.getElementById('root')
      Ae && (0, e.s)(Ae).render((0, oe.jsx)(De, {}))
    })()
})()
