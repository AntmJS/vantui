...
class _C extends React.Component {
  render() {
    const { active, demoIcon, demoImage, icons } = this.data
    return (
      <VanTabs active={active} color="#1989fa" onChange={this.onSwitch}>
        <VanTab title="用法示例" customClass="demo-tab-pane">
          <DemoBlock title="基础用法">
            <VanCol customClass="col" span="6">
              <VanIcon name={demoIcon} size="32px" customClass="icon"></VanIcon>
            </VanCol>
            <VanCol customClass="col" span="6">
              <VanIcon
                name={demoImage}
          ...
          <DemoBlock title="图标大小">
            <VanCol customClass="col" span="6">
              <VanIcon name={demoIcon} size="40" customClass="icon"></VanIcon>
            </VanCol>
            <VanCol customClass="col" span="6">
              <VanIcon name={demoIcon} size="3rem" customClass="icon"></VanIcon>
            </VanCol>
          </DemoBlock>
        </VanTab>
        <VanTab title="基础图标" customClass="demo-tab-pane">
          {icons.basic.map((item, index) => {
            return (
              <VanCol key={item.index} customClass="col" span="6">
                <VanIcon name={item} size="32px" customClass="icon"></VanIcon>
                <View className="text">{item}</View>
              </VanCol>
            )
          })}
        </VanTab>
        <VanTab title="线框风格" customClass="demo-tab-pane">
        ...
        <VanTab title="实底风格" customClass="demo-tab-pane">
