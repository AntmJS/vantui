    ...
    return (
      <Block>
        <VanCell center title="基础用法">
          <VanStepper value={1}></VanStepper>
        </VanCell>
        <VanCell center title="步长设置">
          <VanStepper value={1} step="2"></VanStepper>
        </VanCell>
        <VanCell center title="限制输入范围">
          <VanStepper value={1} min="5" max="8"></VanStepper>
        </VanCell>
        <VanCell center title="限制输入整数">
          <VanStepper value={1} integer></VanStepper>
        </VanCell>
        <VanCell center title="禁用状态">
          <VanStepper value={1} disabled></VanStepper>
        </VanCell>
        <VanCell center title="禁用长按">
          <VanStepper value={1} longPress={false}></VanStepper>
        </VanCell>
        <VanCell center title="固定小数位数">
          <VanStepper value={1} step="0.2" decimalLength={1}></VanStepper>
        </VanCell>
        ...
        <VanCell center title="圆角风格">
          <VanStepper value={1} theme="round" buttonSize="22px"></VanStepper>
        </VanCell>
