...
class _C extends React.Component {
  render() {
    const { text, shortText } = this.data
    return (
      <Block>
        <DemoBlock title="基础用法">
          <VanNoticeBar text={text} leftIcon="volume-o"></VanNoticeBar>
        </DemoBlock>
        ...
        <DemoBlock title="多行展示">
          <VanNoticeBar wrapable scrollable={false} text={text}></VanNoticeBar>
        </DemoBlock>
        <DemoBlock title="通知栏模式">
          <VanNoticeBar mode="closeable" text={shortText}></VanNoticeBar>
          <VanNoticeBar
