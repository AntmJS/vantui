    ...
    return (
      <Block>
        <DemoBlock customClass="white" title="基础用法">
          <VanDropdownMenu>
            <VanDropdownItem value={value1} options={option1}></VanDropdownItem>
            <VanDropdownItem value={value2} options={option2}></VanDropdownItem>
          </VanDropdownMenu>
        </DemoBlock>
        <DemoBlock customClass="white" title="自定义菜单内容">
          <VanDropdownMenu>
            <VanDropdownItem value={value1} options={option1}></VanDropdownItem>
            <VanDropdownItem id="item" title={itemTitle}>
              <VanCell
                title={switchTitle1}
                renderRighticon={
                  <Block>
              ...
              <View style="padding: 5px 16px;">
                <VanButton type="danger" block round onClick={this.onConfirm}>
                  确认
                </VanButton>
              </View>
            </VanDropdownItem>
        ...
        <DemoBlock customClass="white" title="自定义选中状态颜色">
          <VanDropdownMenu activeColor="#1989fa">
            <VanDropdownItem value={value1} options={option1}></VanDropdownItem>
            <VanDropdownItem value={value2} options={option2}></VanDropdownItem>
          </VanDropdownMenu>
        </DemoBlock>
        <DemoBlock customClass="white" title="向上展开">
          <VanDropdownMenu direction="up">
            <VanDropdownItem value={value1} options={option1}></VanDropdownItem>
            <VanDropdownItem value={value2} options={option2}></VanDropdownItem>
          </VanDropdownMenu>
        </DemoBlock>
