      ...
      <Block>
        ...
        <DemoBlock title="通过名称匹配">
          ...
          >
            ...
            <VanTabbarItem name="search" icon="search">
              标签
            </VanTabbarItem>
            <VanTabbarItem name="friends" icon="friends-o">
              标签
            </VanTabbarItem>
            <VanTabbarItem name="setting" icon="setting-o">
              标签
            </VanTabbarItem>
          </VanTabbar>
        </DemoBlock>
        <DemoBlock title="显示徽标">
          ...
          >
            <VanTabbarItem icon="home-o">标签</VanTabbarItem>
            <VanTabbarItem icon="search" dot>
              标签
            </VanTabbarItem>
            <VanTabbarItem icon="friends-o" info="5">
              标签
            </VanTabbarItem>
            <VanTabbarItem icon="setting-o" info="20">
              标签
            </VanTabbarItem>
          </VanTabbar>
        </DemoBlock>
        ...
        <DemoBlock title="切换标签事件">
          ...
          >
            <VanTabbarItem icon="home-o">标签1</VanTabbarItem>
            <VanTabbarItem icon="search">标签2</VanTabbarItem>
            <VanTabbarItem icon="friends-o">标签3</VanTabbarItem>
            <VanTabbarItem icon="setting-o">标签4</VanTabbarItem>
          </VanTabbar>
        </DemoBlock>
      </Block>
    )
