    ...
    return (
      <Block>
        <DemoBlock title="基础用法" padding>
          <VanRow>
            <VanCol span="8" customClass="dark">
              span: 8
            </VanCol>
            <VanCol span="8" customClass="light">
              span: 8
            </VanCol>
            <VanCol span="8" customClass="dark">
              span: 8
          ...
          <VanRow>
            <VanCol span="4" customClass="dark">
              span: 4
            </VanCol>
            <VanCol span="10" offset="4" customClass="light">
              offset: 4, span: 10
            </VanCol>
          </VanRow>
          <VanRow>
            <VanCol offset="12" span="12" customClass="dark">
              offset: 12, span: 12
            </VanCol>
          </VanRow>
        </DemoBlock>
