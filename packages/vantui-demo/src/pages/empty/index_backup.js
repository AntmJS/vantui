    ...
    return (
      <Block>
        <DemoBlock title="基础用法" padding>
          <VanEmpty description="描述文字"></VanEmpty>
        </DemoBlock>
        <DemoBlock title="图片类型">
          <VanTabs active={activeTab} onChange={this.onChange}>
            <VanTab title="通用错误">
              <VanEmpty image="error" description="描述文字"></VanEmpty>
            </VanTab>
            <VanTab title="网络错误">
              <VanEmpty image="network" description="描述文字"></VanEmpty>
            </VanTab>
            <VanTab title="搜索提示">
              <VanEmpty image="search" description="描述文字"></VanEmpty>
            </VanTab>
          </VanTabs>
        </DemoBlock>
        ...
        <DemoBlock title="底部内容" padding>
          <VanEmpty description="描述文字">
            <VanButton round type="danger" customClass="bottom-button">
              按钮
            </VanButton>
          </VanEmpty>
        </DemoBlock>
