...
class _C extends React.Component {
  render() {
    const { column1, column4, column2 } = this.data
    return (
      <Block>
        <DemoBlock title="基础用法">
          <VanPicker columns={column1} onChange={this.onChange1}></VanPicker>
        </DemoBlock>
        ...
        <DemoBlock title="多列联动">
          <VanPicker columns={column4} onChange={this.onChange2}></VanPicker>
        </DemoBlock>
        <DemoBlock title="禁用选项">
          <VanPicker columns={column2}></VanPicker>
        </DemoBlock>
        <DemoBlock title="加载状态">
          <VanPicker loading columns={column4}></VanPicker>
        </DemoBlock>
