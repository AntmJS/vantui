    ...
    return (
      <Block>
        <DemoBlock title="加载类型" padding>
          <VanLoading customClass="demo-loading"></VanLoading>
          <VanLoading customClass="demo-loading" type="spinner"></VanLoading>
        </DemoBlock>
        <DemoBlock title="自定义颜色" padding>
          <VanLoading customClass="demo-loading" color="#1989fa"></VanLoading>
          <VanLoading
        ...
        <DemoBlock title="加载文案" padding>
          <VanLoading customClass="demo-loading" size="24px">
            加载中...
          </VanLoading>
        </DemoBlock>
        <DemoBlock title="垂直排列" padding>
          <VanLoading customClass="demo-loading" size="24px" vertical>
            加载中...
          </VanLoading>
        </DemoBlock>
      </Block>
