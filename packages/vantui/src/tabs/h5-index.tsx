...
import { Sticky } from '../sticky/h5-index'
import {
  getRect,
  getAllRect,
  requestAnimationFrame,
  nextTick,
} from '../common/h5-utils'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={utils.bem('renderNavLeft' + indexRef.current)}>
            {renderNavLeft}
          </div>
          <div
            ...
            style={{
              width: scrollWidth,
              borderColor: color,
              overflowX: scrollable ? 'scroll' : 'auto',
            }}
          >
            <div
              className={
              ...
              style={computed.navStyle(color, type) as React.CSSProperties}
            >
              {type === 'line' && (
                <div
          ...
          <div className={utils.bem('renderNavRight' + indexRef.current)}>
            {renderNavRight}
          </div>
        </div>
      </Sticky>
